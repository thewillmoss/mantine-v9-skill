...
* Update all `@mantine/*` packages to version 9.0.0-alpha.7
...
The `color` prop of the [Text](https://alpha.mantine.dev/llms/core-text.md) and [Anchor](https://alpha.mantine.dev/llms/core-anchor.md) components was removed.
Use the `c` [style prop](https://alpha.mantine.dev/llms/styles-style-props.md) instead:
...
* The [TypographyStylesProvider](https://alpha.mantine.dev/llms/core-typography.md) component was renamed to [Typography](https://alpha.mantine.dev/llms/core-typography.md):
...
The [Popover](https://alpha.mantine.dev/llms/core-popover.md) and [Tooltip](https://alpha.mantine.dev/llms/core-tooltip.md) components no longer accept the `positionDependencies` prop; it is no longer required
...
The [use-fullscreen](https://alpha.mantine.dev/llms/hooks-use-fullscreen.md) hook was split into two hooks: `useFullscreenElement` and `useFullscreenDocument`.
...
The [use-mouse](https://alpha.mantine.dev/llms/hooks-use-mouse.md) hook was split into two hooks: `useMouse` and `useMousePosition`.
This change was required to fix a stale ref issue in the previous implementation.
...
The [use-mutation-observer](https://alpha.mantine.dev/llms/hooks-use-mutation-observer.md) hook now uses the new callback ref approach.
...
The [Collapse](https://alpha.mantine.dev/llms/core-collapse.md) component now uses the `expanded` prop instead of `in`:
...
The [Spoiler](https://alpha.mantine.dev/llms/core-spoiler.md) component's `initialState` prop was renamed to `defaultExpanded` for consistency with other Mantine components:
...
The [Grid](https://alpha.mantine.dev/llms/core-grid.md) component `gutter` prop was renamed to `gap` for consistency with other layout components
(like [Flex](https://alpha.mantine.dev/llms/core-flex.md) and [SimpleGrid](https://alpha.mantine.dev/llms/core-simple-grid.md)). Additionally, new `rowGap` and `columnGap` props
...
The [Grid](https://alpha.mantine.dev/llms/core-grid.md) component no longer uses negative margins for spacing between columns.
